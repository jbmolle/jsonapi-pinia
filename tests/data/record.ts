...
export function normFormat() {
  ...
  return {
    [normWidget1._jp.id]: normWidget1,
    [normWidget2._jp.id]: normWidget2,
    [normWidget3._jp.id]: normWidget3
  }
}
...
export function normFormatWithRels() {
  ...
  normWidget2Rels.widgets = {
    [normWidget1Rels._jp.id]: normWidget1Rels,
    [normWidget3Rels._jp.id]: normWidget3Rels
  }
  normWidget3Rels.widgets = normWidget1Rels

  return {
    [normWidget1Rels._jp.id]: normWidget1Rels,
    [normWidget2Rels._jp.id]: normWidget2Rels,
    [normWidget3Rels._jp.id]: normWidget3Rels
  }
}
